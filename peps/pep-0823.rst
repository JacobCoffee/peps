...
* Exclude requests with this header from data shared with third parties.
* Process the request normally. Return the package files.
* Keep collecting data they need for abuse prevention and operations.
